...
```js
const daniel117622 = {
  favouriteLanguages: ["Python", "TypeScript", "C#", "C++"],
  technologies: ["AWS", "GCP", "Docker", ".NET 8"],
  focus: [
  ...
  featuredProjects: [
    "PyGraph VS Code Extension",
    "Live Vehicle Scraping Platform",
    "AI CV Parsing API",
...
- Web Development: Angular, Jinja , .NET, Tailwind, SQL, MongoDB
- Automation & Workflows: Discord API , Telegram API,  Github Actions
- AI / Data: Computer Vision, OCR, Profiling, Optimization
- DevOps & Infra: Docker, AWS, GCP, Redis, Ansible
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Code-C%23-.NET-informational?style=flat&logo=dotnet&logoColor=white&color=512BD4" />
  ...
  <img src="https://img.shields.io/badge/Backend-.NET%208-informational?style=flat&logo=dotnet&logoColor=white&color=512BD4" />
